...
@ Version 0.1
@ Description It gives you all the weapons
]]
...
RegisterCommand('weaponRoll', function()
  TriggerEvent('chat:addMessage', {
		args = { '^7 Usage: ^2/weaponRoll for a random weapon'} 
    })
    random = weapons[math.random(#weapons)]
    local id  = PlayerPedId()
    TriggerEvent('chat:addMessage', {
		args = { 'You got a ^8' .. random } 
    })
    GiveWeaponToPed (
      id,random,99999,false,true
    )
    SetPedInfiniteAmmo (id,true,random)
